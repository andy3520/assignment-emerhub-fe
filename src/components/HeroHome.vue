<template>
  ...
  >
    <div class="relative">
      ...
      >
        Company profiles in Indonesia, Vietnam and the Philippines
      </h1>
      <p
    ...
    <div
      class="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-top"
    >
      <div class="relative">
        <h4
          class="text-2xl leading-8 font-extrabold text-gray-900 tracking-tight sm:text-3xl sm:leading-9"
        >
          Purchase private company reports in Southeast Asia
        </h4>
          ...
          <li class="mt-10">
            <div class="flex">
              ...
              <div class="ml-4">
                ...
                <p class="mt-2 text-base leading-6 text-gray-500">
                  Who are the board members as per Articles of Association.
                </p>
              </div>
            </div>
          </li>
